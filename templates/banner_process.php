<section class="banner__process" id="process">
    ...
    <ul class="banner__process__cards animatable">
        <li class="banner__process__cards__item">
            ...
            <?php include_once PROJECT_ROOT_PATH . "/templates/components/icon_audit.php" ?>
        ...
        <li class="banner__process__cards__item">
            <div class="banner__process__cards__item__bg"></div>
            <?php include_once PROJECT_ROOT_PATH . "/templates/components/icon_conception.php" ?>
            <div class="banner__process__cards__item__body">
                <h3>Conception</h3>
        ...
        <li class="banner__process__cards__item">
            <div class="banner__process__cards__item__bg"></div>
            <?php include_once PROJECT_ROOT_PATH . "/templates/components/icon_delivery.php" ?>
            <div class="banner__process__cards__item__body">
                <h3>Livraison</h3>
