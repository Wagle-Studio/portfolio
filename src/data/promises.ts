...
export const promisesData = {
  ...
  description: "Concevoir une application sur mesure, ce n'est pas seulement de la programmation. C'est d'abord une question d'écoute, de compréhension métier, et de collaboration.",
  promises: [
    {
      icon: Building,
