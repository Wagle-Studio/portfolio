...
export const processData = {
  ...
  description: "Chaque entreprise est unique. Pour concevoir une application métier pertinente, je commence par comprendre vos besoins et vos processus. Voici comment je procède, étape par étape.",
  steps: [
    {
